...
set PARALLELS_EXE=PTAgent.exe

set PRL_ISO_DIR=%TEMP%\parallels
...
set PRL_SETUP_PATH=%PRL_ISO_DIR%\%PARALLELS_EXE%

if not exist "%PRL_SETUP_PATH%" echo ==^> Unable to unzip "%PRL_ISO_PATH%" & goto exit1
